...
try {
    ...
    if (isset($_GET['id'])) {
        ...
        $mysql->execute();
        $professor = $mysql->fetch(PDO::FETCH_ASSOC);
    }
    ...
    if (
        ...
        $sql = "INSERT INTO professores (nome, email, telefone , cpf, senha)
    ...
    if (
        ...
        $sql = "UPDATE professores SET nome = :nome, email = :email, telefone = :telefone, cpf = :cpf, senha = :senha WHERE idProfessor = :id";
...
<div class="container-fluid p-3" style="background-color: #17093e;">
        <h1 class=" text-black text-center text-light" 
            ...
            <?php echo isset($professor['idProfessor']) ? 'Edição': 'Cadastro'; ?> Professor
        </h1>
    </div>
    <div class="container py-5">
        <div class="row">
            <div class="col-md-8">
                <form id='form'  action="professor_cadastro.php?id=<?php echo $professor['idProfessor']; ?>" method="post">
                    <div>
                    ...
                    <div class="mt-3">
                        ...
                        <input id="form_senha" value="<?php echo isset($professor['senha']) ? $professor['senha'] : ''; ?>" type="password" placeholder="Senha" name="senha" class="form-control" required>
                    </div>
