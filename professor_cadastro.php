    ...
    if (isset($_POST['email']) &&
        ...
        if ($pdo->rowCount() == 1) {
           // $_SESSION['usuario'] = $pdo->fetch(PDO::FETCH_ASSOC)['email'];
            header("Location: professor.php"); // https://www.php.net/manual/function.header.php
        }
            ...
            <div class="col-md-8">
                <form action="professor_cadastro.php?id=<?php echo $professor['idProfessor']; ?>" method="post">
                    <div>
                        ...
                        <input id="form_nome" value="<?php echo isset($professor['nome']) ? $professor['nome'] : ''; ?>" type="text" placeholder="Nome completo" name="nome" class="form-control"
                            required>
                    </div>
                    <div class="mt-3">
                        <label for="form_email" class="form-label">Digite o seu e-mail</label>
                        <input id="form_email" value="<?php echo isset($professor['email']) ? $professor['email'] : ''; ?>" type="email" placeholder="eu@examepl.com" name="email"
                            class="form-control" required>
                    </div>
                    <div class="mt-3">
                        <label for="form_telefone" class="form-label">Digite o seu telefone</label>
                        <input id="form_telefone" 
                        value="<?php echo isset($professor['telefone']) ? $professor['telefone'] : ''; ?>" 
                    ...
                    <div class="mt-3">
                        ...
                        <input id="form_cpf" 
                        value="<?php echo isset($professor['cpf']) ? $professor['cpf'] : ''; ?>"
