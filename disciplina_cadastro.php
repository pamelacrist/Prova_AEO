...
<main>
    <div class="container-fluid p-3" style="background-color: #17093e;">
        <h1 class=" text-black text-center text-light" style="color: white !important;">
            <?php echo isset($disciplina['idDisciplina']) ? 'Edição' : 'Cadastro'; ?> Disciplina
        </h1>
    </div>
    <div class="container py-5">
        <div class="row">
            <div class="col-md-8">
                <form id='form' action="disciplina_cadastro.php?id=<?php echo $disciplina['idDisciplina']; ?>" method="post">
                    <div>
                    ...
                    <div class="mt-3">
                        ...
                        <input id="form_cargaHoraria" value="<?php echo isset($disciplina['cargaHoraria']) ? $disciplina['cargaHoraria'] : ''; ?>" type="number" name="cargaHoraria" class="form-control" required>
                        <div class="mt-3">
